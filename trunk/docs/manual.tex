%  manual.tex
%
%  This is the source file for the PDF documentation provided with
%  COIL.  If you make changes to this file, compile it with your 
%  favorite TeX editor.
%
...
\begin {itemize}
  \item \func {\cint startOI (\cchar * serial)} {startoi}
        ...
        \begin {params}
          \item [serial] The location of the serial port connected to the Create
        \end {params}
        \retnorm
        
  \item \func {\cint setBaud (\oibaud rate)} {setbaud}
  ...
  \item \func {\cint enterPassiveMode ()} {enterpm}
  ...
  \item \func {\cint enterSafeMode ()} {entersm}
  ...
  \item \func {\cint enterFullMode ()} {enterfm}
  ...
  \item \func {\cint runDemo (\oidemo demo)} {rundemo}
        ...
        \begin {params}
          \item [demo] The demo to run (or {\tt DEMO\_ABORT} to stop the current demo)
        \end {params}
        \retnorm
  ...
  \item \func {\cint drive (\short vel, \short rad)} {drive}
        ...
        \begin {params}
          ...
          \item [rad] The turning radius, in $mm$, from the center of the turning circle to the
                center of the Create
        \end {params}
        \retnorm

  \item \func {\cint directDrive (\short Lwheel, \short Rwheel)} {directdrive}
  ...
  \item \func {\cint driveDistance (\short vel, \short rad, \cint dist, \cint interrupt)}
        {drivedistance}
        ...
        \begin {params}
          ...
          \item [dist] Distance in $mm$ the Create should travel before stopping
          \item [interrupt] Set to 0 to have the Create ignore collisions or non-zero to have it
                stop on collision
        \end {params}
        \ret Distance travelled or \fail on error

  \item \func {\cint turn (\short vel, \short rad, \cint angle, \cint interrupt)} {turn}
        ...
        \begin {params}
          \item [vel] Desired velocity in $mm/s$
          \item [rad] Desired turning radius in $mm$
          \item [angle] Angle in degrees the Create should turn before stopping
          \item [interrupt] Set to 0 to have the Create ignore collisions or non-zero to have it
                stop on collision
        \end {params}
        \ret Angle turned or \fail on error 
        
  \item \func {\cint setLEDState (\oiled lflags, \byte pColor, \byte pInten)} {setledstate}
  ...
  \item \func {\cint setDigitalOuts (\oioutput oflags)} {setdo}
        ...
        \begin {params}
          \item [oflags] Output flags for setting the state of the digital outputs
        \end {params}
        \retnorm

  \item \func {\cint setPWMLowSideDrivers (\byte pwm0, \byte pwm1, \byte pwm2)} {setpwmlsd}
  ...
  \item \func {\cint setLowSideDrivers (\oioutput oflags)} {setlsd}
        ...
        sensor) will be set. \\
        \begin {params}
          \item [oflags] Output flags for setting the state of the three drivers
        \end {params}
        \retnorm

  \item \func {\cint sendIRbyte (\byte irbyte)} {sendirbyte}
  ...
  \item \func {\cint writeSong (\byte number, \byte length, \byte* song)} {writesong}
  ...
  \item \func {\cint playSong (\byte number)} {playsong}
  ...
  \item \func {\cint readRawSensor (\oisensor packet, \byte* buffer, \cint size)} {readrawsensor}
  ...
  \item \func {\cint readSensor (\oisensor packet)} {readsensor}
  ...
  \item \func {\cint getDistance ()} {getdist}
  ...
  \item \func {\cint getAngle ()} {getangle}
  ...
  \item \func {\cint getVelocity ()} {getvel}
  ...
  \item \func {\cint getTurningRadius ()} {getturnrad}
  ...
  \item \func {\cint getBumpsAndWheelDrops ()} {getbawd}
   ...
   \item \func {\cint getCliffs ()} {getcliffs}
   ...
   \item \func {\cint* getAllSensors()} {getallsens}
   ...
   \item \func {\cint readRawSensorList (\oisensor* packet\_list, \byte num\_packets, \byte* buffer,
           \cint size)} {readrawsensorlist}
   ...
   \item \func {\cint writeScript (\byte* script, \byte size)} {writescript}
   ...
   \item \func {\cint playScript ()} {playscript}
   ...
   \item \func {\byte* getScript()} {getscript}
   ...
   \item \func {\dbl waitTime (\dbl time)} {waittime}
   ...
   \item \func {\cint waitDistance (\cint dist, \cint interrupt)} {waitdist}
         ...
         \begin {params}
           ...
           \item [interrupt] Set to 0 to ignore collisions or non-zero to have this function exit on
                 collision
         \end {params}
         \ret Distance travelled or \fail on error

   \item \func {\cint waitAngle (\cint angle, \cint interrupt)} {waitangle}
   ...
   \item \func {{\bf void} enableDebug ()} {enabledebug}
   ...
   \item \func {{\bf void} disableDebug ()} {disabledebug}
...
\subsubsection {oi\_baud} \hypertarget{oibaud}{}
Codes to set the buad rate, in bits per second, at which data is sent over the serial port.  The
default is 56700bps.
\begin {quote}
  \begin {tabular}{l|l}
